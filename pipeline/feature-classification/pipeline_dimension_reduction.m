...
for idx_cv_lpo = 1:length(idx_class_pos)
    ...
    % Save all the data which are necessary befor to apply the BoW
    filename_cv = ['cv_', num2str(idx_cv_lpo), '.mat'];
    save(strcat(store_directory, filename_cv), 'training_data', ...
         'training_label', 'testing_data', 'testing_label');
